    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Escaner escanerNull = null;
             ...
             Documento doc10 = new Mapa("M o", "A", 2, "M2", "Me", 50, 10);
            // Documento doc11 = null;
             Documento doc12 = new Mapa("Mo", "l", 5, "M", "e", 5, 1);
           ...
           //  bool addedNulo = escanerMapas + null;
             //bool added10 = escanerNull + doc12;
             ...
             Console.WriteLine("Verificando documentos en el escáner:");
             Console.WriteLine($"¿doc1 está en el escáner? {(escanerLibros == doc1 ? "Sí" : "No")}");
             Console.WriteLine($"¿doc2 está en el escáner? {(escanerLibros == doc2 ? "Sí" : "No")}");
             Console.WriteLine($"¿doc3 está en el escáner? {(escanerMapas == doc3 ? "Sí" : "No")}");
             Console.WriteLine($"¿doc11 está en el escáner? {(escanerMapas == doc12 ? "Sí" : "No")}");
             ...
             Console.WriteLine("Resultados del Informe de Mapas en terminados:");
             ...
             Console.WriteLine("TO STRING SOBRECARGA");
